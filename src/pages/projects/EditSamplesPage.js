      ...
      <div className="flex flex-col p-4">
        ...
        <div className="flex justify-between">
          <div>
            ...
            <h2 className="text-lg">Project: {project.id_project}</h2>
          </div>

          <button className="btn my-auto">Back</button>
        </div>
      </div>
      <div className="">
        <Formik
        ...
        >
          {samples && <EditSampleTable samples={samples} initialSamples={initialSamples} setSamples={setSamples} />}
        </Formik>
      </div>
    </div>
  );
